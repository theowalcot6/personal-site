        ...
        <div className='whole-footer'>
          ...
          <div className='footer-lower'>
            ...
            <div className='lower-grouped'>
              ...
              <div className='lower-lower'><a className='lower-lower' href='https://www.linkedin.com/in/theowalcot/' target='_blank' rel="noreferrer">Linkedin</a> | <a className='lower-lower' href={require("../static/Theo_Walcot_CV.pdf")} download="Theo's CV">Resume</a> | <Link className='lower-lower' to='/work'>Work</Link> | <a className='lower-lower' href='https://github.com/theowalcot6' target='_blank' rel="noreferrer">Github</a> | <a className='lower-lower' href='https://www.kaggle.com/theowalcot' target='_blank' rel="noreferrer">Kaggle</a></div>
            </div>
            <div className='lower-grouped'>
